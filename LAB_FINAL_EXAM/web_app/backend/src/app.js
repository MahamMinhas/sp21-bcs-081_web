...
//MODIFICATIONS FOR LAB FINAL EXAM
app.post('/calculate', (req, res) => {
 ...
 // Store the calculation results in the session array
...
app.get('/calculate', (req, res) => {
 // Pass the session results to the view
 res.render('calculator.ejs', { results: req.session.results || [] });
});
//END
